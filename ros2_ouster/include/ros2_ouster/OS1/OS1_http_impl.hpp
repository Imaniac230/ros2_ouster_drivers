...
#ifndef ROS2_OUSTER__OS1__OS1_HTTP_IMPL_HPP_
#define ROS2_OUSTER__OS1__OS1_HTTP_IMPL_HPP_
 ...
 */
class HttpImpl : public OS1::BaseInterface
{
  public:
  /**
  ...
  std::unique_ptr<CurlClient> http_client;
};

}// namespace OS1

#endif// ROS2_OUSTER__OS1__OS1_HTTP_IMPL_HPP_
