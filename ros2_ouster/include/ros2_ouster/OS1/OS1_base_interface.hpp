...
#ifndef ROS2_OUSTER__OS1__OS1_BASE_INTERFACE_HPP_
#define ROS2_OUSTER__OS1__OS1_BASE_INTERFACE_HPP_

#include <json/json.h>
#include <ros2_ouster/OS1/OS1_util.hpp>
#include <ros2_ouster/interfaces/curl_client.h>
...
class BaseInterface
{
  ...
  /**
     ...
     */
  inline static std::string firmware_version_string(const std::string &hostname)
  {
  ...
  /**
     ...
     * @param[in] hostname hostname of the sensor to communicate with.
     */
  inline static version firmware_version(const std::string &hostname)
  {
  ...
  /**
     ...
     * @param[in] hostname hostname of the sensor to communicate with.
     */
  static std::unique_ptr<BaseInterface> create(const std::string &hostname);
};

}// namespace OS1

#endif// ROS2_OUSTER__OS1__OS1_BASE_INTERFACE_HPP_